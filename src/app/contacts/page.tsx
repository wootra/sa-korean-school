...
const ContactsPage = () => {
    return (
        <CenterMain>
            <div className='flex flex-col w-[600px] mx-auto justify-start items-start'>
                <Heading type='page'>Contacts</Heading>
                <Contacts withHeading={false} className='gap-2' />
            </div>
            <div className='mx-auto w-[600px] h-[450px] py-4 flex flex-col justify-start items-start'>
